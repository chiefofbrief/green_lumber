...
One caveat: These observations are relevant for software applications, not physical applications, for which there is no equivalent to internet data and where foundation models are still being developed.  
